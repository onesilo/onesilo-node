  ...
  const formCard = el("div", { class: "card" },
    ...
    field("Node mode",
      select("mode", cfg.mode, [
        ["local", "local — memory and LLM on this machine only"],
        ["gateway", "gateway — relay to the One Silo control plane"],
      ]),
      "Local never contacts the control plane. Gateway registers this node and relays cloud silos."),
    ...
    el("div", { class: "field-row" },
      field("Tunnel", select("tunnel_mode", cfg.tunnel.mode, [
        ["off", "off"],
        ["quick", "quick — Cloudflare quick tunnel"],
        ["external", "external — bring your own URL"],
      ])),
